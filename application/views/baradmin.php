		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
                ...
                <!--begin::Aside Menu-->
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								<li class="menu-item" aria-haspopup="true">
									<a href= "<?php echo site_url(); ?>UserClient" class="menu-link" class="menu-link">
                ...
                <li class="menu-section">
								...
								<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo site_url(); ?>ProduksiClient" class="menu-link">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo site_url(); ?>Detailproduksiclient" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
                      ...
                      <li class="menu-item" aria-haspopup="true">
												<a href="<?php echo site_url(); ?>Detailstockproduksiclient" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
            ...
            <li class="menu-section">
                  ...
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      ...
                      <polygon fill="#000000" points="14.9671522 4.22441676 7.5999999 8.31727912 7.5999999 12.9056825 9.5999999 13.9056825 9.5999999 9.49408582 17.25507 5.24126912"/>
										...
										<span class="menu-text">Kelola Data Gudang</span>
										<i class="menu-arrow"></i>
									</a>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
												...
												<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo site_url(); ?>Kategoriclient" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
												...
												<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo site_url(); ?>Barangclient" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
												...
												<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo site_url(); ?>StockBarangClient" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
            ...
            <li class="menu-section">
                  ...
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      ...
                      <li class="menu-item" aria-haspopup="true">
					 		<a href="<?php echo site_url(); ?>PengirimanClient" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
					 		<a href="<?php echo site_url(); ?>Detailclient" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
